<?php 
$mainurl="http://localhost/php230mwf/module4/mvc-app/admin/";
$baseurl="http://localhost/php230mwf/module4/mvc-app/admin/assets/";
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo $mainurl;?>admin-dashboard" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Komal Admin</span>
      </a>
